...
<div class=\"img-thumbnail\" style=\"background-image: url('build/images/wallpaper.89d04ce2.jpg');
    ...
    <div class=\"container\">
        ...
        echo "                            </div>
                            ...
                            <div class=\"form-group\">
                                ...
                                ";
        // line 45
        if ((isset($context["phone_number"]) || array_key_exists("phone_number", $context) ? $context["phone_number"] : (function () { throw new RuntimeError('Variable "phone_number" does not exist.', 45, $this->source); })())) {
            // line 46
            echo "                                    <input class=\"form-control\" type=\"text\" name=\"phone-number\" value=\"";
            echo twig_escape_filter($this->env, (isset($context["phone_number"]) || array_key_exists("phone_number", $context) ? $context["phone_number"] : (function () { throw new RuntimeError('Variable "phone_number" does not exist.', 46, $this->source); })()), "html", null, true);
            echo "\" disabled>
                                ";
        } else {
            // line 48
            echo "                                    <input class=\"form-control\" type=\"text\" name=\"phone-number\">
                                ";
        }
        // line 50
        echo "                            </div>
                            ...
                            ";
        // line 60
        if ((isset($context["verification_code"]) || array_key_exists("verification_code", $context) ? $context["verification_code"] : (function () { throw new RuntimeError('Variable "verification_code" does not exist.', 60, $this->source); })())) {
            // line 61
            echo "                                <p>
                                ...
                                <div class=\"col-md-12 text-center\">
                                    <h2>";
            // line 65
            echo twig_escape_filter($this->env, (isset($context["verification_code"]) || array_key_exists("verification_code", $context) ? $context["verification_code"] : (function () { throw new RuntimeError('Variable "verification_code" does not exist.', 65, $this->source); })()), "html", null, true);
            echo "</h2>
                                </div>
                            ";
        }
        ...
        echo "
                            ";
        // line 69
        if ((isset($context["login_error"]) || array_key_exists("login_error", $context) ? $context["login_error"] : (function () { throw new RuntimeError('Variable "login_error" does not exist.', 69, $this->source); })())) {
            // line 70
            echo "                                <div class=\"col-md-12 text-center\">
                                    <p class=\"error\">";
            // line 71
            echo twig_escape_filter($this->env, (isset($context["login_error"]) || array_key_exists("login_error", $context) ? $context["login_error"] : (function () { throw new RuntimeError('Variable "login_error" does not exist.', 71, $this->source); })()), "html", null, true);
            echo "</p>
                                </div>
                            ";
        }
    ...
    ";
        // line 81
        if ((isset($context["verification_code"]) || array_key_exists("verification_code", $context) ? $context["verification_code"] : (function () { throw new RuntimeError('Variable "verification_code" does not exist.', 81, $this->source); })())) {
            // line 82
            echo "    <script>
        fetch(\"/login\", {
            method: \"POST\"
...
";
    ...
    {
        return array (  212 => 88,  204 => 82,  202 => 81,  193 => 74,  187 => 71,  184 => 70,  182 => 69,  179 => 68,  173 => 65,  167 => 61,  165 => 60,  153 => 50,  149 => 48,  143 => 46,  141 => 45,  135 => 41,  131 => 39,  125 => 37,  123 => 36,  113 => 31,  107 => 30,  101 => 29,  94 => 25,  73 => 6,  66 => 5,  53 => 3,  36 => 1,);
    }
...
{% endblock %}
", "login/index.html.twig", "/home/andreas/spaces/SK/mid-rest-php-demo/templates/login/index.html.twig");
    }
}
